...
print(
    lista2, list1
)  # o super é adicionado nas duas listas, porque qualquer alteração que acontecer em uma acontece em outra
# para conseguir receber elementos diferentes apos a copia das listas, podemos fazer
lista2 = (
    list1.copy()
)  # entao aqui ela vai copiar os elementos da list1 para a lista2, mas nao vao estar 'conectadas' entao
lista2.append("super")
list1.append("valor")
print(lista2)
